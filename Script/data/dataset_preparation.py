...
ratings_path = os.path.join(BASE_DIR, "Data", "new_sample_70k.csv")
movies_path = os.path.join(BASE_DIR, "Data", "movies.csv")
output_path = os.path.join(BASE_DIR, "Data", "ratings_preprocessed.csv")
...
# ---------------------------------------------------
# 9. handle any remaining missing values
# ---------------------------------------------------
df = df.fillna(0)
